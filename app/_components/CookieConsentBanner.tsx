...
export default function CookieConsentBanner({
  ...
  return (
    <motion.div
      ...
      className="fixed right-4 bottom-4 left-4 z-50 vertical gap-4 border border-stone-500 bg-stone-900/95 p-4 shadow-lg backdrop-blur-sm md:right-auto md:bottom-8 md:left-1/2 md:-translate-x-1/2 md:transform"
    >
      <p className="text-xs wrap-break-word hyphens-auto text-stone-50 sm:text-left md:max-w-[400px]">
