  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <div className="space-y-4">
        <p>
          Last updated:{" "}
          {DateTime.fromFormat("2025-06-25", "yyyy-MM-dd").toFormat(
            "dd.MM.yyyy",
          )}
        </p>
        ...
        <p>
          ...
          committed to protecting any personal data you may provide through this
          website.
        </p>
        ...
        <p>
          ...
          explicit consent, which you can provide or withdraw through the cookie
          banner displayed on your first visit. Strictly necessary cookies for
          the website&apos;s functionality do not require consent.
        </p>

        <h2 className="mt-6 mb-3 font-semibold">How We Use Your Information</h2>
        <p>
          Data collected through tracking cookies (if accepted) is used for
          traffic analysis and website optimization. We will not use this
          information for other purposes and will not share it with third
          parties, except for the analytics service providers mentioned above.
        </p>
        ...
        <p>
          ...
          personal information. For any questions or requests related to your
